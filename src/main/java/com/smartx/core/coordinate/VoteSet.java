...
public class VoteSet {
    ...
    public boolean addVote(Vote vote) {
        ...
        if (vote.getType() == type && vote.getHeight() == height && vote.getView() == view && vote.getBlockHash() != null && vote.validate() && sig != null && validators.contains(Hex.encode(sig.getAddress()))) {
