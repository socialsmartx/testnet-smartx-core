...
public class CapabilityTreeSet {
    ...
    public static CapabilityTreeSet of(String... capabilities) {
        return new CapabilityTreeSet(Stream.of(capabilities).map(Capability::of).filter(Objects::nonNull).collect(Collectors.toList()));
    }
    /**
    ...
    public boolean equals(Object object) {
        return object instanceof CapabilityTreeSet && Arrays.equals(toArray(), ((CapabilityTreeSet) object).toArray());
    }
    @Override
    public int hashCode() {
