...
/**
 * Represents a server in the Smartx network
 */
public class PeerServer {
    private static final Logger logger = Logger.getLogger(PeerServer.class);
    ...
    public void start(String ip, int port) {
        ...
        try {
            ...
            b.childHandler(new SmartxChannelInitializer(kernel, null));
            logger.info(String.format("Starting peer server: address = {%s}:{%d}", ip, port));
