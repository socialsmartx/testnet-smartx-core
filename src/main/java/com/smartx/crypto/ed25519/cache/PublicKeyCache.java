 ...
 */
package com.smartx.crypto.ed25519.cache;
...
import com.smartx.util.ByteArray;
...
public final class PublicKeyCache {
     ...
     */
    private static final Cache<ByteArray, EdDSAPublicKey> pubKeyCache = Caffeine.newBuilder().maximumSize(MAX_CACHE_SIZE).build();
