 ...
 */
package com.smartx.crypto.ed25519.bip39;
...
public class Dictionary {
    ...
    public Dictionary(Language language) throws IOException {
        InputStream wordStream = this.getClass().getClassLoader().getResourceAsStream("wordlists/" + language.name().toLowerCase() + ".txt");
