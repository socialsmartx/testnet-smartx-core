...
import static com.smartx.util.BIUtil.isLessThan;
import static com.smartx.util.ByteUtil.bigIntegerToBytes;
import static com.smartx.util.ByteUtil.toHexString;
...
import com.smartx.crypto.jce.*;
import com.smartx.util.ByteUtil;

import io.github.novacrypto.base58.Base58;

public class ECKey {
    private static final Logger logger = Logger.getLogger(ECKey.class);
    /**
    ...
    static {
        ...
        org.spongycastle.asn1.x9.X9ECParameters params = org.spongycastle.asn1.sec.SECNamedCurves.getByName("secp256k1");
        CURVE = new org.spongycastle.crypto.params.ECDomainParameters(params.getCurve(), params.getG(), params.getN(), params.getH());
        CURVE_SPEC = new org.spongycastle.jce.spec.ECParameterSpec(params.getCurve(), params.getG(), params.getN(), params.getH());
     ...
     */
    private static org.spongycastle.math.ec.ECPoint extractPublicKey(final ECPublicKey ecPublicKey) {
    ...
    public ECKey(Provider provider, SecureRandom secureRandom) {
        ...
        if (pubKey instanceof org.spongycastle.jcajce.provider.asymmetric.ec.BCECPublicKey) {
            pub = ((org.spongycastle.jcajce.provider.asymmetric.ec.BCECPublicKey) pubKey).getQ();
    ...
    private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
        if (priv == null) {
            ...
            try {
                return ECKeyFactory.getInstance(SpongyCastleProvider.getInstance()).generatePrivate(new org.spongycastle.jce.spec.ECPrivateKeySpec(priv, CURVE_SPEC));
    ...
    public ECKey decompress() {
        ...
        else return new ECKey(this.provider, this.privKey, decompressPoint(pub));
    }
    /**
     @deprecated per-point compression property will be removed in Bouncy Castle
     */
    public ECKey compress() {
        if (pub.isCompressed()) return this;
        else return new ECKey(this.provider, this.privKey, compressPoint(pub));
    }
    /**
    ...
    /**
     Get the SecureRandom of the ECKey
     */
    ...
    /**
     ...
     point addition this timenum of times (i.e. point multiplying).
    ...
    public BigInteger getPrivKey() {
        ...
        } else if (privKey instanceof org.spongycastle.jcajce.provider.asymmetric.ec.BCECPrivateKey) {
            return ((org.spongycastle.jcajce.provider.asymmetric.ec.BCECPrivateKey) privKey).getD();
        } else {
            throw new MissingPrivateKeyException();
        }
    }
    ...
    public String toStringWithPrivate() {
        StringBuilder b = new StringBuilder();
        b.append(toString());
        if (privKey != null && privKey instanceof org.spongycastle.jcajce.provider.asymmetric.ec.BCECPrivateKey) {
            b.append(" priv:").append(toHexString(((org.spongycastle.jcajce.provider.asymmetric.ec.BCECPrivateKey) privKey).getD().toByteArray()));
        }
        return b.toString();
    }
    /**
    ...
    public static class ECDSASignature {
        ...
        public static ECDSASignature decodeFromDER(byte[] bytes) {
            org.spongycastle.asn1.ASN1InputStream decoder = null;
            try {
                decoder = new org.spongycastle.asn1.ASN1InputStream(bytes);
                org.spongycastle.asn1.DLSequence seq = (org.spongycastle.asn1.DLSequence) decoder.readObject();
                if (seq == null) throw new RuntimeException("Reached past end of ASN.1 stream.");
                org.spongycastle.asn1.ASN1Integer r, s;
                try {
                    r = (org.spongycastle.asn1.ASN1Integer) seq.getObjectAt(0);
                    s = (org.spongycastle.asn1.ASN1Integer) seq.getObjectAt(1);
        ...
        public ECDSASignature toCanonicalised() {
            if (s.compareTo(HALF_CURVE_ORDER) > 0) {
                // The order of the curve is the timenum of valid points that exist on that curve. If S is in the upper
                // half of the timenum of valid points, then bring it back to the lower half. Otherwise, imagine that
                //    N = 10
        ...
        public byte[] toByteArray() {
            ...
            return ByteUtil.merge(ByteUtil.bigIntegerToBytes(this.r, 32), ByteUtil.bigIntegerToBytes(this.s, 32), new byte[]{fixedV});
        }
        public String toHex() {
            return org.spongycastle.util.encoders.Hex.toHexString(toByteArray());
        }
        public String toBase58() {
            ...
            System.arraycopy(bigIntegerToBytes(this.r, 32), 0, sigData, 1, 32);
            System.arraycopy(bigIntegerToBytes(this.s, 32), 0, sigData, 33, 32);
            return Base58.base58Encode(sigData);
        }
        public static ECDSASignature decodeFromBase58(String base58Encoded) {
            byte[] signatureEncoded = Base58.base58Decode(base58Encoded);
            ECKey.ECDSASignature recoverSign = ECKey.ECDSASignature.fromComponents(Arrays.copyOfRange(signatureEncoded, 1, 33), Arrays.copyOfRange(signatureEncoded, 33, 65), (byte) (signatureEncoded[0] & 0xFF));
            return recoverSign;
        }
        @Override
    ...
    public ECDSASignature doSign(byte[] input) {
        ...
        if (privKey instanceof org.spongycastle.jcajce.provider.asymmetric.ec.BCECPrivateKey) {
            org.spongycastle.crypto.signers.ECDSASigner signer = new org.spongycastle.crypto.signers.ECDSASigner(new org.spongycastle.crypto.signers.HMacDSAKCalculator(new org.spongycastle.crypto.digests.SHA256Digest()));
            org.spongycastle.crypto.params.ECPrivateKeyParameters privKeyParams = new org.spongycastle.crypto.params.ECPrivateKeyParameters(((org.spongycastle.jcajce.provider.asymmetric.ec.BCECPrivateKey) privKey).getD(), CURVE);
    ...
    public ECDSASignature sign(byte[] messageHash) {
        ...
        if (recId == -1) throw new RuntimeException("Could not construct a recoverable key. This should never happen.");
        sig.v = (byte) (recId + 27);
        return sig;
    }
    /**
    ...
    public static byte[] signatureToKeyBytes(byte[] messageHash, String signatureBase64) throws SignatureException {
        ...
        try {
            signatureEncoded = org.spongycastle.util.encoders.Base64.decode(signatureBase64);
        ...
        return signatureToKeyBytes(messageHash, ECDSASignature.fromComponents(Arrays.copyOfRange(signatureEncoded, 1, 33), Arrays.copyOfRange(signatureEncoded, 33, 65), (byte) (signatureEncoded[0] & 0xFF)));
    }
    ...
    public BigInteger keyAgreement(org.spongycastle.math.ec.ECPoint otherParty) {
        if (privKey == null) {
            ...
            agreement.init(new org.spongycastle.crypto.params.ECPrivateKeyParameters(((org.spongycastle.jcajce.provider.asymmetric.ec.BCECPrivateKey) privKey).getD(), CURVE));
            ...
            try {
                ...
                agreement.doPhase(ECKeyFactory.getInstance(this.provider).generatePublic(new ECPublicKeySpec(otherParty, CURVE_SPEC)),
                        /* lastPhase */ true);
    ...
    public byte[] decryptAES(byte[] cipher) {
        ...
        KeyParameter key = new KeyParameter(BigIntegers.asUnsignedByteArray(((org.spongycastle.jcajce.provider.asymmetric.ec.BCECPrivateKey) privKey).getD()));
    ...
    public static boolean verify(byte[] data, ECDSASignature signature, byte[] pub) {
        org.spongycastle.crypto.signers.ECDSASigner signer = new org.spongycastle.crypto.signers.ECDSASigner();
    ...
    public static byte[] recoverPubBytesFromSignature(int recId, ECDSASignature sig, byte[] messageHash) {
        ...
        org.spongycastle.math.ec.ECCurve.Fp curve = (org.spongycastle.math.ec.ECCurve.Fp) CURVE.getCurve();
        ...
        org.spongycastle.math.ec.ECPoint.Fp q = (org.spongycastle.math.ec.ECPoint.Fp) org.spongycastle.math.ec.ECAlgorithms.sumOfTwoMultiplies(CURVE.getG(), eInvrInv, R, srInv);
    ...
    public byte[] getPrivKeyBytes() {
        if (privKey == null) {
            ...
            return bigIntegerToBytes(((org.spongycastle.jcajce.provider.asymmetric.ec.BCECPrivateKey) privKey).getD(), 32);
        } else {
            return null;
        }
    }
