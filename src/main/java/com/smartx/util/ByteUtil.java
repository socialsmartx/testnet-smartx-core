...
public class ByteUtil {
    ...
    /**
     ...
     it appends a leading zero to indicate that the timenum is positive and may need padding.
    ...
    /**
     ...
     @param value - any big integer timenum. A <code>null</code>-value will return <code>null</code>
    ...
    public static byte[] calcPacketLength(byte[] msg) {
        ...
        return new byte[]{(byte) ((msgLen >> 24) & 0xFF), (byte) ((msgLen >> 16) & 0xFF), (byte) ((msgLen >> 8) & 0xFF), (byte) ((msgLen) & 0xFF)};
    }
    /**
    ...
    /**
     Calculate the timenum of bytes need
     to encode the timenum

     @param val - timenum
     @return timenum of min bytes used to encode the timenum
     */
    ...
    /**
     increment byte array as a timenum until max is reached
    ...
    /**
     Returns a timenum of zero bits preceding the highest-order ("leftmost") one-bit
    ...
    /**
     Parses fixed timenum of bytes starting from {@code offset} in {@code input} array.
