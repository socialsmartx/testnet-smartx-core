...
public class SystemUtil {
    ...
    public static String getIp() {
        try {
            ...
            BufferedReader reader = new BufferedReader(new InputStreamReader(con.getInputStream(), UTF_8));
    ...
    public static boolean isWindowsVCRedist2012Installed() {
        ...
        try {
            if (Platform.is64Bit()) {
                return Advapi32Util.registryGetIntValue(Advapi32Util.registryGetKey(WinReg.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\VisualStudio\\11.0\\VC\\Runtimes\\x64", WinNT.KEY_READ | WinNT.KEY_WOW64_32KEY).getValue(), "Installed") == 1;
            } else {
                return Advapi32Util.registryGetIntValue(WinReg.HKEY_LOCAL_MACHINE, "SOFTWARE\\Microsoft\\VisualStudio\\11.0\\VC\\Runtimes\\x86", "Installed") == 1;
            }
    ...
    public static boolean isJUnitTest() {
        try {
            Class.forName("com.smartx.TestUtils");
            return true;
